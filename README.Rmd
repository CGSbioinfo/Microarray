...
**normalization =** *TRUE or FALSE to perform GCCN-SST normalization on the raw CEL files. Default = TRUE*

**data_target =** *The level at which the RMA normalization is performed. Options are "transcript" or "probeset". Default = transcript*
